...
import HeroImage from "@/public/email-preview.png";
          ...
          <div className="perspective-distant -mr-16 pl-16 lg:-mr-56 lg:pl-56">
            <div className="[transform:rotateX(20deg);]">
              <div className="lg:h-176 relative skew-x-[.36rad]">
                ...
                <Image
                  className="rounded-(--radius) z-1 relative border dark:hidden object-cover"
                  src={HeroImage}
                ...
                />
                <Image
                  className="rounded-(--radius) z-1 relative hidden border dark:block object-cover"
                  src={HeroImage}
                  alt="Tailark hero section"
                  width={2880}
                  height={2074}
